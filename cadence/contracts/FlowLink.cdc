...
// Here we tell Cadence that our FlowLink contract implements the interface
pub contract FlowLink: NonFungibleToken {
  ...
  pub resource interface FlowLinkCollectionPublic {
  ...
  pub resource Collection: FlowLinkCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic {
...
init() {
    ...
    self.account.link<&FlowLink.Collection{NonFungibleToken.CollectionPublic, FlowLink.FlowLinkCollectionPublic}>(
